...
const EditorScreen = () => {
  ...
  if (artworkData == null){
    ...
    return <ThemeProvider theme={theme}><Typography component={'fieldset'} color="textPrimary"><div>
      ...
      <CssTextField id="name_field" label="Name" variant="outlined" defaultValue={artworkData.meta.name}></CssTextField>
      <CssTextField id="song_field" label="Song" variant="outlined" defaultValue={artworkData.meta.songId}></CssTextField>
